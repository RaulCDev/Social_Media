...
const TextAreaPost: React.FC<TextAreaPostProps> = ({
  userName,
  avatarUrl,
  handlePost,
  postId,
  ...
  return (
    <div
      className="dropdown-comment rounded-lg border-b-2 border-gray-800"
      onClick={(e) => {
        e.preventDefault();
      }}>
      {postId && (
      ...
      <div className="flex justify-between gap-3 border-t border-gray-600 pt-2">
        ...
        <div className="flex">
          <button
            className="rounded-full bg-green-600 p-2 hover:bg-green-700 active:bg-green-800"
